...
class Dish(models.Model):
    ...
    @property
    def dish_score(self):
        comments = Comments.objects.filter(order__dish_id=self.dish_id)
        if comments.exists():
            score = comments.aggregate(Avg('comment_score'))['comment_score__avg']
...
class Orders(models.Model):
    ...
    order_status = models.IntegerField(choices=[(0, '已下单'), (1, '备餐中'), (2, '已完成'), (3, '已评价')], default=0, verbose_name='订单状态')
